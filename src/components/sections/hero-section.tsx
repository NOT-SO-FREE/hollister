...
const HeroSection = () => {
  return (
    <div className="max-w-lg mx-auto text-center">
      ...
      <h1 className="text-lg md:text-xl font-bold text-foreground mb-1.5 px-2 relative -mt-4">
      ...
      <p className="text-xs md:text-sm text-foreground/85 mb-2 font-medium px-2 relative">
